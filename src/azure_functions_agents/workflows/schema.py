...
class WorkflowRetryableError(_WorkflowExecutionError):
    ...
    A workflow tool or Sub Agent raises this to classify its own failure as
    transient. The runtime never inspects handler exception types beyond this
    contract: everything else is terminal.
    """
