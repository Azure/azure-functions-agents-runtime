...
| `azure_functions_agents/discovery/mcp.py` | Loads `mcp.json` / `.vscode/mcp.json` and translates remote HTTP server definitions into MAF MCP tool wrappers. | `discover_mcp_servers()` |
