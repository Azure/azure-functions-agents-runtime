...
`[aca_sandbox]` extra. Live sandbox-manifest verification/region binding (P3c) and
reaper reconciliation (P3d) are still separate, not-yet-implemented phases.
