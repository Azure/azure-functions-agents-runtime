...
`[aca_sandbox]` extra. Live sandbox-manifest verification/region binding (P4b/P5a)
and reaper reconciliation (P6) are still separate, not-yet-implemented phases.
