...
| [0006](0006-endpoint-authentication.md) | Endpoint authentication (API key / Entra ID) | Finalized |
| [0007](0007-http-trigger-authentication.md) | HTTP trigger authentication (shared auth model) | Finalized |
