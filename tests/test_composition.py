...
def test_binding_definition_substitutes_environment_in_recognized_fields(
    ...
    _write_agent(
        tmp_path,
        "order-fulfillment.agent.md",
        "name: $TEAM_NAME Processor\ndescription: Processes %TEAM_NAME% orders",
    ...
    assert entry.definition.name == "Fulfillment Processor"
    assert entry.definition.description == "Processes Fulfillment orders"
...
def test_binding_definition_honors_substitution_opt_out(
    ...
    assert entry.definition.name == "$TEAM_NAME Processor"
    assert entry.definition.description == "Processes %TEAM_NAME% orders"
