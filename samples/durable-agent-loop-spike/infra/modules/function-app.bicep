  ...
  properties: union(
    {
      ...
      DURABLE_TASK_SCHEDULER_CONNECTION_STRING: 'Endpoint=${durableTaskSchedulerEndpoint};Authentication=ManagedIdentity;ClientID=${functionIdentityClientId}'
      TASKHUB_NAME: durableTaskHubName
      ...
      AZURE_FUNCTIONS_AGENTS_EXPERIMENTAL_DURABLE_AGENT_LOOP_FAULT_INJECTION_ENABLED: string(faultInjectionEnabled)
