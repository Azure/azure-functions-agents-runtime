...
@description('Email address to send the daily calendar summary to.')
...
var functionAppName = '${abbrs.webSitesFunctions}calendar-${resourceToken}'
...
var office365McpServerConfigName = 'Office-365-Outlook-calendar-email'
...
module apiUserAssignedIdentity 'br/public:avm/res/managed-identity/user-assigned-identity:0.4.1' = {
  ...
  params: {
    location: location
    tags: tags
    name: '${abbrs.managedIdentityUserAssignedIdentities}calendar-${resourceToken}'
  }
}
...
// Office 365 Outlook connector (calendar read + email send)
